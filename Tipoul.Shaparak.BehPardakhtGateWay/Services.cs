...
using Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest;
using Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest;

namespace Tipoul.Shaparak.BehPardakhtGateWay
{
    public class Services
    {

        public async Task<Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.OutModel> bpPayRequest(Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.InModel model)
        {
            ...
            Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.OutModel om = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.OutModel();
            if (resultArray[0] == "0")
            {
                ...
                Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.ResultObject ro = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpPayRequest.ResultObject();
        ...
        public async Task<Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.OutModel> bpVerifyRequest(Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.InModel model)
        {
            var pgc = new PaymentGatewayClient();
            ...
            Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.OutModel om = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.OutModel();
            if (resultArray == "0")
            {
                ...
                Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.ResultObject ro = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpVerifyRequest.ResultObject();
        ...
        public async Task<Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.OutModel> bpSettleRequest(Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.InModel model)
        {
            var pgc = new PaymentGatewayClient();
            ...
            string resultArray = result.Body.@return;
            Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.OutModel om = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.OutModel();
            if (resultArray == "0" || resultArray == "45")
            {
                ...
                Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.ResultObject ro = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpSettleRequest.ResultObject();
        ...
        public async Task<Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.OutModel> bpInquiryRequest(Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.InModel model)
        {
            var pgc = new PaymentGatewayClient();
            ...
            string resultArray = result.Body.@return;
            Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.OutModel om = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.OutModel();
            if (resultArray == "0")
            {
                ...
                Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.ResultObject ro = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpInquiryRequest.ResultObject();
        ...
        public async Task<Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.OutModel> bpReversalRequest(Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.InModel model)
        {
            var pgc = new PaymentGatewayClient();
            ...
            string resultArray = result.Body.@return;
            Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.OutModel om = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.OutModel();
            if (resultArray == "0")
            {
                ...
                Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.ResultObject ro = new Tipoul.Shaparak.BehPardakhtGateWay.Model.BpReversalRequest.ResultObject();
