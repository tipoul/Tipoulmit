...
namespace Tipoul.Framework.Services.OpenBanking.Shahin.Inquiry.Account
{
    public class GetaccountBalance
    {
        ...
        public async Task<AccountBalanceResult?> GetAccountBalances(AccountBalance model,string ApiUrl,string UserName,string Password, string access_token, string? extraParameterForlog)
        {
            ...
            CallApi _cai = new CallApi();
                ...
                AccountBalanceResult resultModel = JsonSerializer.Deserialize<AccountBalanceResult>(responseString);
