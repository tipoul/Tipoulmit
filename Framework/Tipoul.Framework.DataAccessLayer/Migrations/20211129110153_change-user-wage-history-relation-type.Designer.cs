...
namespace Tipoul.Framework.DataAccessLayer.Migrations
{
    ...
    [Migration("20211129110153_change-user-wage-history-relation-type")]
    partial class changeuserwagehistoryrelationtype
    {
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.UserWageHistory", b =>
                {
                    ...
                    b.Property<int?>("UserWageTypeHistoryId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserWageTypeHistoryId1");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.UserWageHistory", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.UserWageTypeHistory", "UserWageTypeHistory")
                        .WithMany()
                        .HasForeignKey("UserWageTypeHistoryId1")
                        .OnDelete(DeleteBehavior.NoAction);
