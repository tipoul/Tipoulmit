...
namespace Tipoul.Framework.DataAccessLayer.Migrations
{
    ...
    partial class TipoulFrameworkDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.CommertialGateWay", b =>
                {
                    ...
                    b.Property<int?>("ETrustStarsCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.GetTokenResult", b =>
                {
                    ...
                    b.Property<string>("TipoulAccessTokenHashed")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.Settlement", b =>
                {
                    ...
                    b.Property<long>("AmountInBankAfterSettlement")
                        .HasColumnType("bigint");

                    b.Property<long>("AmountInTipoulAfterSettlement")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("DocutmentURL")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("QuickSettlement")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.Transaction", b =>
                {
                    ...
                    b.Property<bool>("InvalidCallbackUrl")
                        .HasColumnType("bit");

                    b.Property<bool>("InvalidReferer")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.UserWageTypeHistory", b =>
                {
                    ...
                    b.Property<double>("QuickSettlementWagePercent")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.Wallet", b =>
                {
                    ...
                    b.Property<long>("AmountInHand")
                        .HasColumnType("bigint");

                    b.Property<long>("AmountInTipoul")
                        .HasColumnType("bigint");

                    b.Property<long>("AmountSettlementable")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.WalletDepositRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<long>("AmountAfterDeposit")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("DepositerName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DepositerNationalCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestIbanNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceAcountNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SourceIbanNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceOwnerName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SourceOwnerNationalCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("WalletDepositRequests");
                });

            modelBuilder.Entity("Tipoul.Framework.StorageModels.WalletDepositRequestStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("WalletDepositRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WalletDepositRequestId");

                    b.ToTable("WalletDepositRequestStatusHistories");
                });
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.CommertialGateWay", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.BankAccount", "DefaultBankAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.Transaction", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.UserWageHistory", "UserWageHistory")
                        .WithMany()
                        .HasForeignKey("UserWageHistoryId");
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.UserWageHistory", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.UserWageTypeHistory", "UserWageTypeHistory")
                        .WithMany()
                        .HasForeignKey("UserWageTypeHistoryId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.WalletDepositRequest", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.Wallet", "Wallet")
                        .WithMany("WalletDepositRequests")
                        .HasForeignKey("WalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.WalletDepositRequestStatusHistory", b =>
                {
                    ...
                    b.HasOne("Tipoul.Framework.StorageModels.WalletDepositRequest", "WalletDepositRequest")
                        .WithMany("WalletDepositRequestStatusHistories")
                        .HasForeignKey("WalletDepositRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("User");

                    b.Navigation("WalletDepositRequest");
                });
            ...
            modelBuilder.Entity("Tipoul.Framework.StorageModels.Wallet", b =>
                {
                    ...
                    b.Navigation("WalletDepositRequests");
                });

            modelBuilder.Entity("Tipoul.Framework.StorageModels.WalletDepositRequest", b =>
                {
                    b.Navigation("WalletDepositRequestStatusHistories");
                });
