    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData("Users",
                new string[] { nameof(User.UserName), nameof(User.Password), nameof(User.IsEmailConfirmed), nameof(User.IsMobileNumberConfirmed) },
                new object[] { "admin", "admin", false, false });
        }
